...
help:
	...
	@echo "  make                    - One command for complete standard build"
	@echo "  make dev                - One command for complete development build"
	@echo ""
	@echo -e "$(BLUE)🧪 Development Testing (requires 'make dev'):$(NC)"
	@echo "  make check              - Basic autotools tests (works with standard build too)"
	@echo "  make test-full          - Comprehensive tests with memory leak detection"
	@echo "  make test-scenarios     - All 4 test scenarios (detection, RGB, macros, failures)"
	...
	@echo "  make test-ci            - Full CI suite (DESTRUCTIVE - rebuilds project)"
	@echo ""
